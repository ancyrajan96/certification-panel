...
if(isset($_POST['post_msg'])){
    ...
    $msg=$_POST['msg'];
    $dt=date('Y-m-d');
    $ins_msg=mysqli_query($con,"insert into msg_tovil values('','$vn','$pin','$pto','$mt','$msg','$dt','1')");
    if($ins_msg>0){
        header("location:msg_toadmin.php");
    }
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Send Message to Administrator</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12"><center>
                        ...
                        <tr>
                            <td colspan="2" style="background-color: blueviolet; color:white"><center><b>POST MESSAGE HERE</b><span style="float: right"><a href="msg_toadmin.php"><img src="logo/close_button5.gif" /></a></span></center></td>
                        </tr>
                        <tr>
                            <td>Message Posted To</td>
                            <td><input type="text" name="pto" value="admin" class="form-control" readonly="readonly" /></td>
                        </tr>
                        <tr>
                            <td>Message Title</td>
                        ...
                        <tr>
                            ...
                            <?php
                        $sel_msg=mysqli_query($con,"select * from msg_tovil where msg_frmid='$pin'");
                        if(mysqli_num_rows($sel_msg)>0){
                            $i=1;
                            ?>
                            <h3>Message Posted By You</h3></center><hr />
                        ...
                        <?php
                            while($r_msg=mysqli_fetch_row($sel_msg)){
                              ?>
                                <tr>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $r_msg[4] ?></td>
                                    <td><?php echo $r_msg[5] ?></td>
                                    <td>
                                        <?php echo $r_msg[3] ?>
                                    </td>
                                </tr>
