...
<div class=" row">
    <div class="col-md-2 col-sm-2 col-xs-6">
        <?php
        $count_deo=mysqli_query($con,"select * from deo_info where vpin='$pin'");
        $deo=  mysqli_num_rows($count_deo);
        ?>
    ...
    <div class="col-md-2 col-sm-2 col-xs-6">
        <?php
        $count_cit=mysqli_query($con,"select * from cit_info where v_pin='$pin'");
        $c_count=mysqli_num_rows($count_cit);
        ?>
    ...
    <div class="col-md-2 col-sm-2 col-xs-6">
        <?php
        $count_msg=mysqli_query($con,"select * from msg_tovil where msg_to='$pin'");
    ...
    <div class="col-md-2 col-sm-2 col-xs-6">
        <?php
        $count_msg=mysqli_query($con,"select * from msg_tovil where msg_frmid='$pin'");
        $msgcount=mysqli_num_rows($count_msg);
        ?>
        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12"><center>
                    <img src="logo/Assembly11.jpg" class="img img-responsive" />
                    </center>
