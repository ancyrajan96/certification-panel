    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Find Your Certificate status</h2>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <span id="cct" style="display: none;">
                                            <?php
                                            $sel_cst=mysqli_query($con,"select * from caste_cert where req_frmid='$usr' order by id desc");
                                            ...
                                            <?php
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <?php
                                                             ...
                                                             ?>
                                                         <a href="cast_printuser.php?id=<?php echo $r_cst[0] ?>"><img src="logo/print.png" /></a>
                                                         <?php
                                                         }
                                                         ?>
                                                     </td>
                                              ...
                                              ?>
                                                ...
                                                echo"No Certificate Request from You";
                                        ...
                                        <span id="inc" style="display: none;">
                                            <?php
                                            $sel_cst=mysqli_query($con,"select * from sal_cert where req_frmid='$usr' order by id desc");
                                            if(mysqli_num_rows($sel_cst)>0){
                                                $i=1;
                                                ?>
                                             <table class="table table-bordered table-condensed table-hover table-responsive">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <?php
                                                             ...
                                                             ?>
                                                         <a href="income_printuser.php?id=<?php echo $r_cst[0] ?>"><img src="logo/print.png" /></a>
                                                         <?php
                                                         }
                                                         ?>
                                                     </td>
                                        ...
                                        <span id="mar" style="display: none;">
                                            <?php
                                            $sel_cst=mysqli_query($con,"select * from nat_cert where req_frmid='$usr' order by id desc");
                                            if(mysqli_num_rows($sel_cst)>0){
                                                $i=1;
                                                ?>
                                             <table class="table table-bordered table-condensed table-hover table-responsive">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         ...
                                                         <?php
                                                             ...
                                                             ?>
                                                         <a href="nativity_printuser.php?id=<?php echo $r_cst[0] ?>"><img src="logo/print.png" /></a>
                                                         <?php
                                                         }
                                                         ?>
                                                     </td>
