...
if(isset($_POST['add_tk'])){
    ...
    $dt=$_POST['dt'];
    $tk=$_POST['tk'];
    $ins_tk=mysqli_query($con,"insert into tal_info values('','$st','$dt','$tk','1')");
    if($ins_tk>0){
        header("location:tal_manage.php");
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Manage Taluk</h2>
                    ...
                    <div class="col-lg-5">
                        <table class="table table-bordered table-condensed table-hover table-responsive">
                            <tr>
                                <td>Choose State</td>
                                <td>
                                    <select name="st" id="st" data-rel="chosen" class="form-control" onchange="shodist(this.value)">
                            ...
                            function shodist(x){
                                ...
                                xhttp.open("GET", "load_dis.php?sid="+x, true);
                                xhttp.send();
                            }
                            </script>
                            <tr>
                            ...
                            <tr>
                                <td>Enter Taluk</td>
                                <td><input type="text" name="tk" class="form-control" /></td>
                            </tr>
                            <tr>
                                <td colspan="2"><center><input type="submit" name="add_tk" value="Add Taluk" class="btn btn-success" /></center></td>
                            </tr>
                        </table>
                    </div>  
                    <div class="col-lg-7">
