...
if(isset($_POST['sub']))
{
    ...
    $amt=$_POST['amt'];
    $dt=date('Y-m-d');
    $ins_tax=mysqli_query($con,"insert into village_tax values('','$v_pin','$usr','$t_id','$tn','$bn','$dt','$v_id','$vn','$sn','$ah','$ar','$pn','$pb','$pp','$amt',0)");
    if($ins_tax>0){
                ...
                <div class="col-lg-12 col-md-12">                      
                        <div class="col-lg-6">
                            ...
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                ...
                                <tr>
                                    <td>Taluk Name</td>
                                    <td><input type="text" name="tn" value="<?php echo $tn[3] ?>" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td>Village Name</td>
                                    <td><input type="text" name="vn" value="<?php echo $vn[4] ?>" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td>Survey Number / Subdivision / Letter</td>
                                    <td><textarea name="sn" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td>Area in Hector</td>
                                    <td><textarea name="ah" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td>Area in R</td>
                                    <td><textarea name="ar" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td>Name (pattadaran)</td>
                                    <td><textarea name="pn" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td>Payment By</td>
                                    <td><input type="text" name="pb" value="<?php echo $r_usr[5] ?>" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td>Payment Period</td>
                                    <td><input type="text" name="pp"  class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td>Amount</td>
                        ...
                        while($r_tax=mysqli_fetch_row($sel_tax))
                        {
                            ...
                            <tr>
                                ...
                                <td><center>
                                    ...
                                    {
                                        ?>
                                    <a href="print_tax.php?id=<?php echo $r_tax[0] ?>" target="_BLANK"><span class="btn btn-sm btn-success">Print</span></a>
                                    <?php
                                    }
                                    ?>
