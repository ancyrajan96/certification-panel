...
if(isset($_POST['sub'])){
    $rpl=$_POST['rpl'];
    $dt=date('Y-m-d');
    $ins_rpl=mysqli_query($con,"insert into app_rply values('','".$_GET['apid']."','$dt','$rpl')");
    if($ins_rpl>0){
        header("location:admin_application.php?apid=".$_GET['apid']);
    }
}
?>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Direct Application</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    <div class="col-lg-6">
                        <?php
                        $sel=mysqli_query($con,"select * from sec_app order by id desc");
                        ...
                        <?php
                        $i=1;
                            while($r_app=mysqli_fetch_row($sel))
                            {
                                ?>
                            <tr>
                                <td><?php echo $i ?></td>
                                <td><?php echo $r_app[1] ?></td>
                                <td><?php echo $r_app[5] ?></td>
                                <td><a href="admin_application.php?apid=<?php echo $r_app[0] ?>"><img src="logo/read.png" /></a></td>
                            </tr>
                            <?php
                            $i++;
                            }
                    ...
                    <div class="col-lg-6">
                       <?php
                       if(isset($_GET['apid'])){
                           $up=mysqli_query($con,"update sec_app set st=1 where id='".$_GET['apid']."'");
                           $sel_app=mysqli_query($con,"select * from sec_app where id='".$_GET['apid']."'");
                           $rapp=mysqli_fetch_row($sel_app);
                           ?>
                        <form method="post">
                        ...
                        <table class="table table-bordered table-condensed">
                            <tr>
                                <td colspan="2">Posted By :<b> <?php echo $rapp[5] ?></b></td>
                            </tr>
                            <tr>
                                <td>Application Title</td>
                                <td><?php echo $rapp[1] ?></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <b>Description</b><br />
                            ...
                            <tr>
                                ...
                                <td><a href="usr_app/<?php echo $rapp[3] ?>" target="_blank">View</a> </td>
                            </tr>
                            <tr>
                                <td colspan="2"><div onclick="sho_msg()"><center><b>PREVIOUS REPLAYS</b></center></div></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <span id="rp" style="display: none;">
                                        <?php
                                        $sel_rp=mysqli_query($con,"select * from app_rply where appid='".$_GET['apid']."'");
                                        if(mysqli_num_rows($sel_rp)>0){
                                            ?>
                                        <table class="table table-bordered table-condensed">
                                            <tr>
                                        ...
                                        <?php
                                            while($r_rp=mysqli_fetch_row($sel_rp))
                                            {
                                                ?>
                                            <tr>
                                                <td><?php echo $r_rp[2] ?></td>
                                                <td><?php echo $r_rp[3] ?></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
                            ...
                            <tr>
                                <td colspan="2"><center>POST REPLAY</center></td>
                            </tr>
                            <tr>
                                <td colspan="2"><textarea name="rpl" class="form-control"></textarea></td>
                            </tr>
                            <tr>
                                <td colspan="2"><center><input type="submit" name="sub" value="post Reply" class="btn btn-success" /></center></td>
                            </tr>
                        </table>
                            </form>
                        <?php
