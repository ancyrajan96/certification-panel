    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Pending Certificate Requests</h2>
                        ...
                        <div class="col-lg-10">
                            ...
                            <table class="table table-bordered table-condensed table-hover table-hover table-responsive">
                                <tr style="background-color: #2a62bc; color: white; cursor: pointer" onclick="load_cst()">
                                    <?php 
                                    $count_cst=mysqli_query($con,"select * from caste_cert where req_to='$pin' and sts=0");
                                    $c_count=mysqli_num_rows($count_cst);
                                    ?>
                                    <td>Caste Certificate Request ::(<?php echo $c_count ?> Pending) </td>
                                </tr>
                                <tr>
                                    <td>
                                        <span id="creq" style="display: none">
                                        <?php 
                                        $sel_cst=mysqli_query($con,"select * from caste_cert where req_to='$pin' and sts=0");
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="c_approve.php?id=<?php echo $r_cst[0] ?>" title="Approve"><img src="logo/tick.png" /></a> | <a href="p_req.php?t=1&id=<?php echo $r_cst[0] ?>" title="Reject"><img src="logo/cross.png" /></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
                                ...
                                <?php 
                                    $count_sal=mysqli_query($con,"select * from sal_cert where req_to='$pin' and sts=0");
                                    $c_sal=mysqli_num_rows($count_sal);
                                    ?>
                                <tr style="background-color: brown; color: white; cursor: pointer"  onclick="load_cst1()">
                                    <td>Income Certificate Request :: (<?php echo $c_sal ?> Pending)</td>
                                </tr>
                                <tr>
                                    <td>
                                        <span id="creq1" style="display: none">
                                            <?php 
                                        $sel_cst=mysqli_query($con,"select * from sal_cert where req_to='$pin' and sts=0");
                                        if(mysqli_num_rows($sel_cst)>0){
                                            $i=1;
                                            ?>
                                        <table class="table table-bordered table-condensed table-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="c_approve1.php?id=<?php echo $r_cst[0] ?>" title="Approve"><img src="logo/tick.png" /></a> | <a href="p_req.php?t=1&id=<?php echo $r_cst[0] ?>" title="reject"><img src="logo/cross.png" /></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
                                ...
                                <?php 
                                    $count_sal=mysqli_query($con,"select * from nat_cert where req_to='$pin' and sts=0");
                                    $c_sal=mysqli_num_rows($count_sal);
                                    ?>
                                <tr style="background-color: green; color: white; cursor: pointer"  onclick="load_cst2()">
                                    <td>Nativity Certificate Request :: (<?php echo $c_sal ?> Pending)</td>
                                </tr>
                                <tr>
                                    <td>
                                        <span id="creq2" style="display: none">
                                            <?php 
                                        $sel_cst=mysqli_query($con,"select * from nat_cert where req_to='$pin' and sts=0");
                                        if(mysqli_num_rows($sel_cst)>0){
                                            $i=1;
                                            ?>
                                        <table class="table table-bordered table-condensed table-hover table-responsive">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $r_cst[2] ?></td>
                                                <td><?php echo $r_cst[9] ?></td>
                                                <td><a href="c_approve2.php?id=<?php echo $r_cst[0] ?>" title="Approve"><img src="logo/tick.png" /></a> | <a href="p_req.php?t=1&id=<?php echo $r_cst[0] ?>" title="Reject"><img src="logo/cross.png" /></a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
