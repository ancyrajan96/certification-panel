    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Complaints</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-9">
                        <?php
                        $sel_cmp=mysqli_query($con,"select * from cmp_info order by post_date desc");
                        if(mysqli_num_rows($sel_cmp)>0)
                            {
                            $i=1;
                            ?>
                        ...
                        <?php
                            while ($r_cmp=mysqli_fetch_row($sel_cmp)){
                                ?>
                                 <tr>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $r_cmp[1] ?></td>
                                    <td><?php echo $r_cmp[3] ?></td>
                                    <td><?php echo $r_cmp[4] ?></td>
                                    <td><?php echo $r_cmp[5] ?></td>
                                </tr>
                                <?php
                            }
                            ?>
