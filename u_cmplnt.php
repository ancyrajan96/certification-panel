...
if(isset($_POST['post_cmp'])){
    $ct=$_POST['ct'];
    $cmp=$_POST['cmp'];
    $dt=date('Y-m-d');
    $ins_cmp=  mysqli_query($con,"insert into cmp_info values('','$r_usr[5]','$usr','$ct','$cmp','$dt','$v_pin','1')");
    if($ins_cmp>0){
        header("location:u_cmplnt.php");
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> User Home :: Post Complaint</h2>
                        ...
                        <div class="col-lg-8">
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                <tr>
                                    ...
                                    <td><input type="text" name="ct" class="form-control" placeholder="Complaint Title" /></td>
                                </tr>
                                <tr>
                                    <td><textarea name="cmp" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" name="post_cmp" value="Post Complaint" class="btn btn-success" /></td>
                                </tr>
                                
                                
                            </table>
                            <h4>Your Feedback Info</h4>
                            <?php
                            $sel_fb=mysqli_query($con,"select * from cmp_info where cmp_frmid	='$usr' order by post_date desc");
                            if(mysqli_num_rows($sel_fb)>0){
                                $i=1;
                                ?>
                            ...
                            <?php
                                while($r_fb=mysqli_fetch_row($sel_fb)){
                                    ?>
                                <tr>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $r_fb[3] ?></td>
                                    <td><?php echo $r_fb[4] ?></td>
                                    <td><?php echo $r_fb[5] ?></td>
                                </tr>
                            <?php
                            $i++;
                                }
