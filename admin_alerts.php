...
<div class="ch-container">
    <div class="row">
        ...
        <div id="content" class="col-lg-10 col-sm-10">
            ...
            <div>
    <ul class="breadcrumb">
        <a href="admin_alerts.php?t=1"><div class="btn btn-primary">Quick Contacts</div></a>
        <a href="admin_alerts.php?t=2"><div class="btn btn-primary">Public Informations</div></a>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> User Home :: admin Alerts</h2>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    if(isset($_GET['t'])){
                        ...
                        while($r_cat=mysqli_fetch_row($sel_cat)){
                            ?>
                    <a href="admin_alerts.php?t=<?php echo $_GET['t'] ?>&cat=<?php echo $r_cat[0] ?>"><span class="btn btn-warning"><?php echo $r_cat[1] ?></span></a>
                    <?php
                        }
                        if(isset($_GET['cat'])){
                            if($_GET['t']==1){
                            $sel_data=mysqli_query($con,"select * from cat_info_contact where cat_id=".$_GET['cat']);
                        }
                        if($_GET['t']==2){
                            $sel_data=mysqli_query($con,"select * from cat_info_contact1 where cat_id=".$_GET['cat']);
                        }
                        ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            while($r_data=mysqli_fetch_row($sel_data)){
                                ?>
                            <tr>
                                <td><?php echo $r_data[2] ?></td>
                                <td><?php echo $r_data[3] ?></td>
                            </tr>
                            <?php
                            }
                            ?>
