    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> User Home :: My Profile</h2>
                ...
                <div class="col-lg-12 col-md-12"><center>
                        ...
                        <div class="col-lg-8">
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                ...
                                <tr>
                                    <td colspan="2"><b>OTHER FAMILY MEMBERS</b></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <?php
                                        $sel_oth=mysqli_query($con,"select * from cit_info where w_num='$w_num' and h_num='$h_num' and v_pin='$v_pin'");
                                        if(mysqli_num_rows($sel_oth)>0){
                                            while($r_oth=  mysqli_fetch_row($sel_oth)){
                                                if($r_oth[10]!=$usr){
                                                echo "$r_oth[5]<br />";
                                                }
