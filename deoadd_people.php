...
if(isset($_POST['add_citzn'])){
    $nme=$_POST['nme'];
    $wd=$_POST['wd'];
    $hn=$_POST['hn'];
    $addr=nl2br($_POST['addr']);
    $ins_cit=mysqli_query($con,"insert into cit_info values('','$sid','$did','$tid','$vid','$nme','$wd','$hn','$addr','$pin','no','no','no','0','0','0','1','no','0','0','0')");
    if($ins_cit>0){
        header("location:deoadd_people.php");
    }
}
?>
<!DOCTYPE html>
...
<div class=" row">
   ...
   <!--   <div class="col-md-3 col-sm-3 col-xs-6">
        <a data-toggle="tooltip" title="0" class="well top-block" href="deo_msg.php">
                ...
                <div class="col-lg-12 col-md-12"><center>
                        <div class="col-lg-5">
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                ...
                                <tr>
                                    <td>House Number</td>
                                    <td><input type="text" name="hn" class="form-control" onblur="loadaddress(this.value,'<?php echo $pin ?>')" /></td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td><textarea id="addr" name="addr" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><center><input type="submit" name="add_citzn" value="Add Citizen" class="btn btn-success" /></center></td>
                                </tr>
                            </table>
                            <script type="text/javascript">
                            function loadaddress(a,b){
                                var w=document.getElementById("wd").value;
                                xmlhttp=new XMLHttpRequest();
                                xmlhttp.open("GET","load_address.php?hn="+a+"&vpin="+b+"&wd="+w,true);
                                xmlhttp.send();
