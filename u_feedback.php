...
if(isset($_POST['post_fb'])){
    $fb=$_POST['fb'];
    $dt=date('Y-m-d');
    $ins_fb=  mysqli_query($con,"insert into fb_info values('','$usr','$r_usr[5]','$fb','$dt','$r_usr[12]','1')");
    if($ins_fb>0){
        header("location:u_feedback.php");
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> User Home :: Post Feed back</h2>
                ...
                <div class="col-lg-12 col-md-12"><center>
                        ...
                        <div class="col-lg-8">
                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                ...
                                <tr>
                                    <td><textarea name="fb" class="form-control"></textarea></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" name="post_fb" value="Post FeedBack" class="btn btn-success" /></td>
                                </tr>
                            ...
                            <?php
                            $sel_fb=mysqli_query($con,"select * from fb_info where usrid='$usr' order by post_dt desc");
