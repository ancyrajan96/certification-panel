...
if(isset($_POST['app_cst']))
{
    ...
    $up_cert=mysqli_query($con,"update nat_cert set app_date='$dt',cert_id='$cnum',seal='$seal',sign='$sig', sts=1 where id='".$_GET['id']."'");
    if($up_cert>0){
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Approve Nativity Certificate</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12"><center>
                        ...
                        <div class="col-lg-8">
                            <?php
                            $sel_cst=mysqli_query($con,"select * from nat_cert where id='".$_GET['id']."'");
                            ...
                            <table class="table table-bordered table-condensed table-hover table-hover table-responsive">
                                ...
                                <tr>
                                    <td style="padding-top: 12px;">Reason for Nativity Certificate</td>
                                    <td><input type="text" name="as" value="<?php echo $r_cst[8] ?>" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td style="padding-top: 12px;">Local Area</td>
                                    <td><input type="text" name="isb" value="<?php echo $r_cst[12] ?>" readonly="readonly" class="form-control" /></td>
                                </tr>
                                <tr>
