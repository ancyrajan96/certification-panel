    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> FeekBack</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-lg-9">
                        <?php 
                        $sel_fb=mysqli_query($con,"select * from fb_info order by post_dt desc");
                        if(mysqli_num_rows($sel_fb)>0){
                            while($r_fb=  mysqli_fetch_row($sel_fb)){
                              ?>
                        <div style="width: 800px;">
                            <div style="float: left"><img src="user_pic/<?php echo $r_fb[5] ?>" width="75" class="img img-circle" /></div>
                            <div style="float: left; padding: 10px; width:600px"><?php echo $r_fb[3] ?><br /><span style="float: right">Posted By : <b><?php echo $r_fb[2] ?></b> on <?php echo $r_fb[4] ?></span></div>
                        </div>
                        <?php
                            }                            
                        }
                        else{
                            echo"No User Feedbacks Found";                            
                        }
                        ?>
