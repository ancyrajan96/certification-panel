...
if(isset($_POST['app_cst']))
{
    ...
    $up_cert=mysqli_query($con,"update caste_cert set caste='$cst',sub_cast='$scst',iss_date='$dt',cert_id='$cnum',seal='$seal',sign='$sig', sts=1 where id='".$_GET['id']."'");
    if($up_cert>0){
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Approve Caste Certificate</h2>
            ...
            <div class="box-content row">
                <div class="col-lg-12 col-md-12"><center>
                        ...
                        <div class="col-lg-8">
                            <?php
                            $sel_cst=mysqli_query($con,"select * from caste_cert where id='".$_GET['id']."'");
                            ...
                            <table class="table table-bordered table-condensed table-hover table-hover table-responsive">
                                ...
                                <tr>
                                    <td style="padding-top: 12px;">Enter Cast</td>
                                    <td><input type="text" name="cst" class="form-control" /></td>
                                </tr>
                                <tr>
                                    <td style="padding-top: 12px;">Enter Sub Cast</td>
                                    <td><input type="text" name="scst" class="form-control" /></td>
                                </tr>
                                <tr>
